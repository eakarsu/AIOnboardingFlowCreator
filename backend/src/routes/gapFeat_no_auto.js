...
// Gap Feature: No \'/auto
// No /auto-optimize-flow (continuously tune flow based on outcomes)
...
async function callLLM(systemPrompt, userPrompt) {
  ...
  const res = await fetchFn('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'X-Title': 'AIOnboardingFlowCreator / gap-no-auto',
    },
    body: JSON.stringify({
