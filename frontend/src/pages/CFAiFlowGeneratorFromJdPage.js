...
// Custom Feature: AI flow generator from JD
// AI flow generator from JD: Upload job description; AI generates custom onboarding flow with tailored checklists, learning resources, and mentor pairings
import React, { useState } from 'react';

export default function CFAiFlowGeneratorFromJdPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-flow-generator-from-jd/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI flow generator from JD</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>AI flow generator from JD: Upload job description; AI generates custom onboarding flow with tailored checklists, learning resources, and mentor pairings</p>
