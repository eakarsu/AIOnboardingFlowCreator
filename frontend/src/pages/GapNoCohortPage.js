...
export default function GapNoCohortPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-cohort/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/cohort</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /cohort-comparison-ai (compare onboarding outcomes across cohorts)</p>
