...
export default function GapNoRolePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-role/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/role</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /role-specific-content-ai (deeper role-conditional content generation)</p>
